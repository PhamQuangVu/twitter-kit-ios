Pod::Spec.new do |s|
  ...
  s.authors = "Tao Ren"
  s.platform = :ios, "9.0"
  s.source = { :git => "https://github.com/PhamQuangVu/twitter-kit-ios.git", :http => "https://github.com/PhamQuangVu/twitter-kit-ios/releases/download/v#{s.version}/TwitterKit.zip" }
